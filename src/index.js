...
// console.log(res.rows[0].message) // Hello world!
  ...
  app.get('/blog', (req, res) => {
    res.set('content-type', 'text/html')
    return res.send(blog({ articles: [{ title: 'Some title', excerpt: 'This is some lorem lipsum text...', slug: 'some-title' }, { title: 'Some other title', excerpt: "And what about this one. It's a bit longer, but hey, who cares. We need to test this one, so why not just pour out some text here.", slug: 'some-other-title' }] }))
  })
